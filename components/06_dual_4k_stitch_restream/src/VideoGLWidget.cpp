...
bool VideoGLWidget::ensureTextureForFrame(const StitchedFrame& holder) {
...
bool VideoGLWidget::uploadFrameToTexture(const StitchedFrame& holder) {
...
void VideoGLWidget::onNewFrame(StitchedFrame* holder) {
    if (m_nextHolder) {
        delete m_nextHolder;
    }
    m_nextHolder = holder;
