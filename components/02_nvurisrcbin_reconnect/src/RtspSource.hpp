...
// Same shape as the P0.1 holder so the GL widget below can stay byte-for-byte
// the same. Duplicated here on purpose — the architecture rule is "no shared
// code between components in early phases".
struct FrameHolder {
